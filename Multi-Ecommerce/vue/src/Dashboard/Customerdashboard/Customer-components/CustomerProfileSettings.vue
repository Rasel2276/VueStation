...
/* --- FULLY RESPONSIVE SYMMETRIC FIXES --- */
...
@media (max-width: 650px) {
  .profile-settings { padding: 20px 15px; } /* Same Left & Right Margin */
  .settings-card { border-radius: 24px; }
  .modern-form { padding: 30px 20px; } /* Same Left & Right Padding inside form */
...
@media (max-width: 375px) {
  ...
  .avatar-edit-wrapper { width: 110px; height: 110px; }
}
</style>