<template>
    <aside :class="['sidebar', { collapsed }]">
        ...
        <nav class="nav-links">
            <!-- Dashboard Link -->
            <RouterLink to="/VendorDefaultLayout" class="nav-item" exact-active-class="active">
                <span class="icon">🏠</span>
...
<script setup>
...

    {
        ...
        label: 'UI Products',
        children: [
        { icon: '📦', label: 'MyStock', to: '/ui-product/mystock' },
        { icon: '➕', label: 'Add Poroduct', to: '/ui-product/add-product' },
        { icon: '🛠️', label: 'Manage Product', to: '/ui-product/manage-product' },
        ],
    },
