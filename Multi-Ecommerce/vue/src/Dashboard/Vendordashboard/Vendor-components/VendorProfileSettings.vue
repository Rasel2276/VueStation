...
.modern-form { padding: 30px 50px; } /* Reduced top/bottom padding from 50px to 30px */
...
.avatar-edit-wrapper {
  position: relative; width: 120px; height: 120px; /* Slightly reduced */
...
.profile-title { margin-top: 15px; font-size: 20px; font-weight: 700; color: #1e293b; } /* Reduced margin and font size */
.avatar-hint { margin-top: 4px; font-size: 12px; color: #94a3b8; font-weight: 400; }
...
.input-field { display: flex; flex-direction: column; gap: 6px; } /* Reduced from 10px */
.input-field label {
...
.prime-btn-gradient {
  ...
  color: #fff;
  border: none;
  padding: 15px 45px; /* Reduced padding from 18px to 15px */
  border-radius: 20px;
  font-size: 16px;
  font-weight: 700;
  cursor: pointer;
